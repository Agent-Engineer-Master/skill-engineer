"""Append an event to the reimagine-industry run log.

Usage:
    python log_run.py --slug <slug> --event <event-name> [--note "..."]

Appends to <industry-dir>/run-log.json (shared with analyze-industry).
"""
...
def main() -> int:
    ...
    if not log_path.exists():
        print(f"ERROR RunLogMissing: {log_path} not found.", file=sys.stderr)
