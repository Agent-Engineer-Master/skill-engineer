...
# Analysis Quality Review — Review-Only Multi-Mode Grader
...
| `standard` | D1–D5 (governing observation, MECE, SCQA, dot-dash narrative, evidence carries) | D1–D5 (action titles, so-what, specificity, code/jargon, active voice) |
| `high` | D1–D7 (adds Rumelt kernel test, Frankenstein detection) | D1–D7 (adds Frankenstein detection, one-message discipline) |
...
- `references/rubric-readability.md` — `review pass: 2` dimensions (D1-D7), tests, pass/fail criteria (framework-independent)
