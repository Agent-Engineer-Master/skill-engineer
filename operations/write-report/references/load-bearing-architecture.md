...
This is the architectural decision that distinguishes `write-report` from a generic prose reviewer (e.g., `seo-review-loop`). It is load-bearing — removing it makes the skill dangerous.
