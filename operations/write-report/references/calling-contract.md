...
```
TEMPLATE_PATH: .claude/skills/write-report/references/authoring-templates/<structural_framework>.md
```
...
2. Verify all required agent files exist at `.claude/skills/write-report/agents/` (`artifact-loader.md`, `argument-structure-reviewer.md`, `readability-reviewer.md`).
3. If `strictness ≥ standard` and `doc_type ∈ {brief, memo, decision-record, deck}`: validate manifest is present.
4. If `audit_dir` not supplied: create `tasks/write-report/<doc-slug>-<YYYYMMDD-HHMM>/`, snapshot the document to `00-original.md`, and invoke `artifact-loader` once to build `<audit_dir>/load_bearing_index.yaml`.
...
Read .claude/skills/write-report/SKILL.md and run with:
...
#   PASS: 1
#   VERDICT: FAIL
#   VIOLATION_REPORT_PATH: tasks/write-report/industrial-robotics-na-20260519/p1-iter1-report.md
#   FIX_PATTERNS_PATH: .claude/skills/write-report/references/fix-patterns.md
#   AUDIT_DIR: tasks/write-report/industrial-robotics-na-20260519/
...
strictness: high
audit_dir: tasks/write-report/industrial-robotics-na-20260519/
previous_violations: tasks/write-report/industrial-robotics-na-20260519/p1-iter1-report.md
caller_skill: reimagine-industry
...
#   PASS: 1
#   VERDICT: PASS
#   VIOLATION_REPORT_PATH: tasks/write-report/industrial-robotics-na-20260519/p1-iter2-report.md
#   FIX_PATTERNS_PATH: .claude/skills/write-report/references/fix-patterns.md
#   AUDIT_DIR: tasks/write-report/industrial-robotics-na-20260519/
