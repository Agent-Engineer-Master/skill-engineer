...
# Response:
#   TEMPLATE_PATH: .claude/skills/write-report/references/authoring-templates/minto-pyramid.md
```
...
#   PASS: spec-judge
#   VERDICT: FAIL
#   VIOLATION_REPORT_PATH: tasks/write-report/dtc-ecommerce-us-20260520/spec-iter1-report.md
#   FIX_PATTERNS_PATH: .claude/skills/write-report/references/fix-patterns.md
#   AUDIT_DIR: tasks/write-report/dtc-ecommerce-us-20260520/
```
...
iteration: 2
spec_path: tasks/reimagine-industry/dtc-ecommerce-us/working/authoring-spec.md
template_path: .claude/skills/write-report/references/authoring-templates/brief.md
audit_dir: tasks/write-report/dtc-ecommerce-us-20260520/
previous_violations: tasks/write-report/dtc-ecommerce-us-20260520/spec-iter1-report.md
caller_skill: reimagine-industry
...
#   PASS: spec-judge
#   VERDICT: PASS
#   VIOLATION_REPORT_PATH: tasks/write-report/dtc-ecommerce-us-20260520/spec-iter2-report.md
#   FIX_PATTERNS_PATH: .claude/skills/write-report/references/fix-patterns.md
#   AUDIT_DIR: tasks/write-report/dtc-ecommerce-us-20260520/
```
...
6. Re-invokes `write-report` with the same `audit_dir` and `previous_violations` pointing at the prior report. The reviewer grades the new state. V-12 marked RESOLVED.
