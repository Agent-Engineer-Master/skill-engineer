...
1. **Rubric:** `Read .claude/skills/write-report/references/rubric-readability.md`
2. **Applicability matrix:** `Read .claude/skills/write-report/references/applicability-matrix.md`
2b. **Tone of voice (REQUIRED at strictness ≥ standard):** `Read .claude/skills/write-report/references/tone-of-voice.md` — the positive register target that D8 (concept density) and D9 (register fit) grade against. Skip only at `strictness: low`.
...
5. **Worked examples (reference only):** `Read .claude/skills/write-report/references/worked-examples.md` — for ambiguous cases
