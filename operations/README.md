...
|---|---|---|
| [analysis-quality-review](analysis-quality-review/) | Review-only multi-mode quality grader for reader-facing analytical deliverables — returns authoring templates, judges storylines before writing, and audits argument structure (Minto Pyramid / MECE / SCQA / Rumelt kernel) and readability of finished documents | Grading the rigour and readability of a report, strategy deck, industry analysis, or executive document |
...
| [prompt-engineer-master](prompt-engineer-master/) | Creates robust long-form task prompts and agent briefs using production patterns — layered XML architecture, trust boundaries, anti-rationalization rules, numeric anchors. Includes an embedded Librarian sub-agent for domain research on complex prompts | Creating agent/system prompts, multi-source workflow prompts, or any prompt that needs to be clearer, more reliable, and easier to debug |
